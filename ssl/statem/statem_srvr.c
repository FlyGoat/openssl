...
static int tls_early_post_process_client_hello(SSL_CONNECTION *s)
{
    ...
    if (SSL_CONNECTION_IS_TLS13(s)) {
        ...
        /*
         * RFC 8998: If server advertise TLS_SM4_GCM_SM3 or TLS_SM4_CCM_SM3,
         * the named group must be curveSM2.
         */
        if (cipher->id == TLS1_3_CK_SM4_GCM_SM3 || cipher->id == TLS1_3_CK_SM4_CCM_SM3) {
